    ...
    navItems: [
      {
        ...
        items: [
          ...
          { label: "Strategic Goals", page: "PlanningGoals",        icon: "Flag" },
          { label: "Plans",           page: "PlanningPlans",        icon: "FolderOpen" },
          { label: "Initiatives",     page: "PlanningInitiatives",  icon: "Activity" },
          { label: "KPI Scorecard",   page: "PlanningScorecard",    icon: "BarChart3" },
          { label: "Reports",         page: "PlanningReports",      icon: "FileText" },
          { label: "Calendar",        page: "PlanningCalendar",     icon: "Calendar" },
        ],
      },
    ],
  },
